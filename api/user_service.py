...
def welcome_email(user_email, wallet, uuid):
  if user_email is not None:
    ...
    html = ( '<!doctype html><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type"content="text/html; charset=UTF-8"/><title>EDM</title><meta name="viewport"content="width=device-width, initial-scale=1.0"/>'
                 '</head><body>'
 	'<table border="0" cellpadding="0" cellspacing="0" width="100%"><tbody><tr><td style="font-family: '"STHeiti Light"', '"Helvetica"', '"arial"', '"Microsoft Yahei"', '"sans-serif"'">'
	...
	'src="https://'+str(email_domain)+'/assets/img/logo.png"></div></td></tr><tr><td style="font-size:20px;font-weight:bold;color:#034F92;padding:30px 10px 0px 10px;text-align:center;">Welcome To HcOmniwallet!</td></tr><tr><td '
	...
	'10px;text-align:center;">Your Wallet Login Details</td></tr><tr><td style="font-size:13px;color:#555;padding:10px 10px 10px 10px;">This is your<b>Wallet ID:</b>'+str(uuid)+'<br>Never share your Wallet ID or Password with '
	'anyone.Be sure to keep them safe and stored separately for security.<br><br>This is your unique<b>Login Link:</b>'
        ' <a style="color:#0e5bc9;"href="https://'+str(email_domain)+'/login/'+str(uuid)+'">https://'+str(email_domain)+'/login/'+str(uuid)+'</a><br>'
	...
	'style="color:#0e5bc9; "href="https://'+str(email_domain)+'/about/faq"> FAQ </a>page.<br>If you have any questions please feel free to reach out to us using the information on our <a ' 
	'style="color:#0e5bc9; "href="https://'+str(email_domain)+'/about/contact"> Contact Us </a>page.<br></td></tr><tr><td style="border-top: 1px solid #BABCC0; font-size:16px;color:#1B222D;padding:30px 10px 10px'
